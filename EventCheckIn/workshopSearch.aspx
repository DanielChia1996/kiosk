<%@ Page Title="" Language="C#" MasterPageFile="~/WorkshopBrowser.Master" AutoEventWireup="true" CodeBehind="workshopSearch.aspx.cs" Inherits="EventCheckIn.workshopSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent1" runat="server">
    ...
    <%--      <asp:GridView ID="GVWorkshops" runat="server" AutoGenerateColumns="False" DataKeyNames="workshopID" DataSourceID="workshopLinqDS" EmptyDataText="No Workshops Found">
    ...
    <asp:GridView ID="TestGV" runat="server" AutoGenerateColumns="False" DataKeyNames="workshopID" DataSourceID="workshopLinqDS" EmptyDataText="No Workshops Currently Available">
        <Columns>
    ...
    <asp:LinqDataSource ID="workshopLinqDS" runat="server" ContextTypeName="EventCheckIn.EventCheckInDataClassesDataContext"
        EntityTypeName="" TableName="workshops" OnSelecting="workshopLinqDS_Selecting">
    </asp:LinqDataSource>
