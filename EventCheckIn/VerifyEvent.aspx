<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyEvent.aspx.cs" Inherits="EventCheckIn.VerifyEvent" %>
                            ...
                            <div class="column one">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Kiosk Pin:</td>
                                         <td>
                                             <asp:TextBox runat="server" ID="tbKioskPassword" TextMode="Password" MaxLength="6" Width="125px" />
                                             <asp:RequiredFieldValidator ID="pinRequiredValidator" runat="server"
                                                 ControlToValidate="tbKioskPassword"
                                                 ErrorMessage="Blank Passwords are not allowed." SetFocusOnError="true"
                                                 Style="color: #FF3300; font-size: small; font-weight: 700; font-style:italic" Text="**"
